...
- 2026-02-22: Swipeable task cards - SwipeableTaskCard component with touch gestures (swipe left to reveal 4 actions: star/bookmark, priority change, complete, delete), portal-based priority picker, pending state protection, starred field on tasks table. Integrated in task-list.tsx and dashboard.tsx mobile views.
