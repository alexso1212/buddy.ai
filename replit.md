...
- **GraphChatFloat:** A floating AI chat panel within the graph view that enables screenshot capture of the SVG graph, sending it as an image attachment for AI visual analysis. Chat history is persisted.
