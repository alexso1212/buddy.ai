...
import {
  ...
  Loader2, Copy, Trash2, Plus, Check, Sun, Monitor,
} from "lucide-react";
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '0 20px 40px' }}>
        <div style={{ marginBottom: 20 }}>
          <label style={{ fontSize: 13, color: '#7A7874', display: 'block', marginBottom: 6, paddingLeft: 2 }}>Full Name</label>
          <input
            value={displayName}
        ...
        <div style={{ marginBottom: 20 }}>
          <label style={{ fontSize: 13, color: '#7A7874', display: 'block', marginBottom: 6, paddingLeft: 2 }}>Email</label>
          <input
        ...
        <button
          ...
          style={{
            ...
            height: 44,
            borderRadius: 12,
            background: profileSaving || displayName.trim() === authUser?.displayName ? 'rgba(255,255,255,0.08)' : '#ECECEC',
            color: profileSaving || displayName.trim() === authUser?.displayName ? '#7A7874' : '#1E1D1A',
            border: 'none',
            fontSize: 15,
            fontWeight: 600,
            cursor: profileSaving || displayName.trim() === authUser?.displayName ? 'not-allowed' : 'pointer',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            gap: 8,
        ...
        <div style={{ fontSize: 14, color: '#7A7874', marginBottom: 16, fontWeight: 500 }}>Change Password</div>

        <div style={{ marginBottom: 16 }}>
          <label style={{ fontSize: 13, color: '#7A7874', display: 'block', marginBottom: 6, paddingLeft: 2 }}>Current Password</label>
          <input
            type="password"
        ...
        <div style={{ marginBottom: 16 }}>
          <label style={{ fontSize: 13, color: '#7A7874', display: 'block', marginBottom: 6, paddingLeft: 2 }}>New Password</label>
          <input
            type="password"
            value={newPassword}
        ...
        <div style={{ marginBottom: 20 }}>
          <label style={{ fontSize: 13, color: '#7A7874', display: 'block', marginBottom: 6, paddingLeft: 2 }}>Confirm New Password</label>
          <input
            type="password"
        ...
        <button
          ...
          style={{
            ...
            color: passwordSaving || !currentPassword ? '#7A7874' : '#ECECEC',
            border: 'none',
            fontSize: 15,
            fontWeight: 600,
            cursor: passwordSaving || !currentPassword ? 'not-allowed' : 'pointer',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            gap: 8,
        ...
        {isLoading ? (
          ...
          <>
            ...
            {(authUser?.role === 'owner' || authUser?.role === 'admin') && (
              <>
                <div style={{ fontSize: 14, color: '#7A7874', marginBottom: 12, fontWeight: 500 }}>Invite Members</div>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontSize: 16, color: '#9A9893' }}>Coming soon</div>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 12 }}>
        ...
        <div style={{ fontSize: 20, fontWeight: 600, color: '#ECECEC' }}>Buddy</div>
        <div style={{ fontSize: 14, color: '#7A7874' }}>Version 0.1.0</div>
        <div style={{ fontSize: 13, color: '#7A7874', marginTop: 8 }}>AI-powered task management</div>
      </div>
    </div>
  );
}
        ...
        <div style={{
          ...
          <div style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden' }}>
            ...
            <div style={{
              ...
              <Divider />
              <SettingsItem icon={CreditCard} label="Billing" value="Free" onClick={() => navigateTo('about')} testId="settings-nav-billing" />
            </div>
            ...
            <div style={{
              ...
              {(authUser?.role === 'owner' || authUser?.role === 'admin') && (
                <>
                  <Divider />
                  <SettingsItem icon={Users} label="Permissions" onClick={() => navigateTo('permissions')} testId="settings-nav-permissions" />
                </>
              )}
            </div>
            ...
            <div style={{
              ...
              />
              <Divider />
              <SettingsItem icon={Globe} label="Language" value="中文" testId="settings-nav-language" />
              <Divider />
